...
export const LIST_PROPERTIES = gql`
  query ListAllProperties($propertyType: PropertyType, $limit: Int, $page: Int, $approvalStatus: ApprovalStatus) {
    listProperties(propertyType: $propertyType, limit: $limit, page: $page, approvalStatus: $approvalStatus) {
      success
      count
      nextToken
      totalPages
