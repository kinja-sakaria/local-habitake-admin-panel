...
export default function PropertyListingTable({ user, activeTab }) {
  ...
  const columns = [
    ...
    activeTab === 2
      ? { key: 'numberOfViews', label: t('propertyListing.numberOfViews') }
      : { key: 'registrationDate', label: t('propertyListing.registrationDate') },
    activeTab === 2 ? { key: 'location', label: t('propertyListing.location') } : { key: 'country', label: t('propertyListing.country') },
    activeTab === 2
      ? { key: 'price', label: t('propertyListing.price') }
      : { key: 'listingPrice', label: t('propertyListing.listingPrice') },
          ...
          <TableHead>
            <TableRow bgcolor="#F8F9FA">
              ...
              <TableCell sx={{ fontSize: '18px' }}>
                {' '}
                {activeTab === 2 ? t('propertyListing.numberOfViews') : t('propertyListing.registrationDate')}
              </TableCell>
              <TableCell sx={{ fontSize: '18px' }}>
                {activeTab === 2 ? t('propertyListing.location') : t('propertyListing.country')}
              </TableCell>
              <TableCell sx={{ fontSize: '18px' }}>
                {activeTab === 2 ? t('propertyListing.price') : t('propertyListing.listingPrice')}
              </TableCell>
