...
function ApexDonutChart({ activeTab }) {
  ...
  useEffect(() => {
    ...
    if (activeTab === 2) {
      labels = [t('userProfile.residential'), t('userProfile.rental'), t('userProfile.commercial'), t('userProfile.luxury')];
...
export default function StatusOverview({ activeTab }) {
  ...
  const stats = [
    activeTab === 2
      ? { label: t('userProfile.residential'), value: 350, color: 'pink' }
      : { label: t('userProfile.publicProperty'), value: 350, color: 'pink' },
    activeTab === 2
      ? { label: t('userProfile.rental'), value: 300, color: 'teal' }
      : { label: t('userProfile.privateProperty'), value: 300, color: 'teal' },
    activeTab === 2
      ? { label: t('userProfile.commercial'), value: 30, color: 'orange' }
      : { label: t('userProfile.approvedProperty'), value: 30, color: 'orange' },
    activeTab === 2
      ? { label: t('userProfile.luxury'), value: 20, color: 'goldenrod' }
      : { label: t('userProfile.pendingProperty'), value: 20, color: 'goldenrod' },
  ];
