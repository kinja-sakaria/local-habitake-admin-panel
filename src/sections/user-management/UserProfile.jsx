    ...
    useEffect(() => {
        if (data?.getUser?.success && data?.getUser?.data) {
            ...
            const transformedUser = {
                ...
                dateOfBirth: apiUserData.dateOfBirth && apiUserData.dateOfBirth.trim()
                    ? (() => {
                        try {
                ...
                createdAt: apiUserData.createdAt && apiUserData.createdAt.trim()
                    ? (() => {
                        try {
                    ...
                    : 'N/A',
                updatedAt: apiUserData.updatedAt && apiUserData.updatedAt.trim()
                    ? (() => {
                        try {
