    ...
    useEffect(() => {
        if (data?.getProperty?.success && data?.getProperty?.data) {
            ...
            const transformedProperty = {
                ...
                createdAt: apiPropertyData.createdAt && apiPropertyData.createdAt.trim()
                    ? (() => {
                        try {
                    ...
                    : 'N/A',
                updatedAt: apiPropertyData.updatedAt && apiPropertyData.updatedAt.trim()
                    ? (() => {
                        try {
                    ...
                    : 'N/A',
                approvedAt: apiPropertyData.approvedAt && apiPropertyData.approvedAt.trim()
                    ? (() => {
                        try {
