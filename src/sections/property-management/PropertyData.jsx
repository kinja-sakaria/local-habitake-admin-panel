...
export default function PropertyData({ activeTab, onViewUser, onTabChange }) {
    ...
    const getStatusFilter = useCallback((tab) => {
        switch (tab) {
            case 0: return 'APPROVED'; // Residential tab - approved properties
            case 1: return 'PENDING'; // Commercial tab - pending properties
            default: return null; // No filter for all properties
        }
    }, []);
  ...
  BULK_APPROVE_PROPERTIES,
  {
    ...
    const transformedProperties = useMemo(() => {
        return properties.map((property) => ({
            ...
            registrationDate: property.createdAt
