...
const PropertyDetailsCard = ({ property }) => {
    const features = [
        { label: 'Bedroom', key: 'bedroom', paddingLeft: true, value: property?.bedrooms, icon: '/assets/images/property-details/bed.svg' },
        { label: 'Bathroom', key: 'bathroom', paddingLeft: true, value: property?.bathrooms, icon: '/assets/images/property-details/Bathtub.svg' },
        { label: 'Parking', key: 'parking', paddingLeft: true, value: property?.parkingSpots, icon: '/assets/images/property-details/parking-spots.svg' },
        { label: 'Views', key: 'views', paddingLeft: true, value: property?.viewsCount, icon: '/assets/images/property-details/property-views.svg' },
    ];
