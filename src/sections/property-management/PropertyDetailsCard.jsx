...
const PropertyDetailsCard = ({ property }) => {
  const features = [
    { label: 'Bedroom', key: 'bedroom', paddingLeft: true, value: property?.bedrooms, icon: '/assets/images/property-details/bed.svg' },
    {
      ...
      icon: '/assets/images/property-details/Bathtub.svg',
    },
    {
      label: 'Parking',
      key: 'parking',
      ...
      icon: '/assets/images/property-details/parking-spots.svg',
    },
    {
      label: 'Views',
      key: 'views',
      ...
      icon: '/assets/images/property-details/property-views.svg',
    },
  ];
